...
<html>
 ...
 <body>
  ...
  <div class="container box">
   <h3 align="center">Date Range Fiter Data Spending/Cost in Laravel using Ajax</h3><br />
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"{{ route('date_range.fetch_data') }}",
   method:"POST",
   ...
   success:function(data)
   {
    ...
    {
     output += '<tr>';
     output += '<td>' + data[count].date_spending + '</td>';
