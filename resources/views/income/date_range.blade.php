...
<html>
 ...
 <body>
  ...
  <div class="container box">
   <h3 align="center">Date Range Fiter Data Income in Laravel using Ajax</h3><br />
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"{{ route('income.date_range.fetch_data') }}",
   method:"POST",
   ...
   success:function(data)
   {
    ...
    {
     output += '<tr>';
     output += '<td>' + data[count].date_income + '</td>';
     output += '<td>' + data[count].name_product + '</td>';
     output += '<td>' + data[count].quantity + '</td>';
     output += '<td>' + data[count].resource_id + '</td>';
